...
First, compare the mileage of cars with automatic transmissions to those with manual transmissions.
...
A regression of mileage as a function of only tranmission type, see Figure 2, shows the difference in average mileage is significant 
...
remember *correlation does not imply causation*.Is the mileage difference due to the transmission type or is it due to other factors such as weight or horsepower?
